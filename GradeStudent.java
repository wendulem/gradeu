...
class GradeStudent {
   ...
   public GradeStudent(MongoCollection<Document> collection,
         List<String> nametype, GradeMain grademain,
      ...
      // A JPanel is created and all the score data is fed in for it to
      // be shown for
      // each subject
...
//Below is extra formatting of the JFrame after the panel has an instance created		
   ...
   // Action listener to go back to the main panel from external subject
   // specific
   // ones
   ...
   // Gets the student frame to be reference when each view button is
   // clicked
