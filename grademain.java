...
public class grademain {
	...
	private static JTextField userField = new JTextField(12);

	private static JPasswordField passField = new JPasswordField(12);
	private static String userValue;
	private static String passValue;
	static MongoClient mongoClient = new MongoClient(new MongoClientURI(
			"mongodb+srv://wendulem:9og8op33ttkLkpYj@cluster0-ugj9q.mongodb.net/test?retryWrites=true"));
	private static MongoDatabase database = mongoClient.getDatabase("GradeU");
	private static MongoCollection<Document> profileCollection = database.getCollection("profiles");
	...
	public static void operatemain() {
		...
		Document userDocument = profileCollection.find((Bson) obj).projection(
	...
	public static JFrame getUserFrame() {
		return userFrame;
	}

	public static void operateUserField() {
		userField.setText("");
	}

	public static void operatePassField() {
		passField.setText("");
	}
