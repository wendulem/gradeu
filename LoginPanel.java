...
class LoginPanel extends JPanel {
	...
	LoginPanel(GradeMain grademain) {
		...
		// This class is the JPanel for GradeMain and below is the swing code
	...
	private class InputActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent ae) {
			...
			// Getting the values from user input to be used in authentications once
			// submitted
	...
	void operateUserField() {
		user_field.setText("");
	}

	void operatePassField() {
		pass_field.setText("");
	}

	// These get the user inputs to be used in the seperate grademain class
	String getUserValue() {
		return user_value;
	}
