...
class GradeTeacherCalc implements ConstantInterface {
   ...
   private void gradeCalcTeacher() {
      ...
      subject_scoretype = subjectdatamongo
            .calcScoreStrings(subject_collection, "scoretype");
      subject_scorename = subjectdatamongo
            .calcScoreStrings(subject_collection, "scorename");
      subject_scoregot = subjectdatamongo
            .calcScoreDoubles(subject_collection, "scoregot");
      subject_scoreout = subjectdatamongo
            .calcScoreDoubles(subject_collection, "scoreout");
      ...
      int valuecap = (subject_scoretype.size()
            + subject_scorename.size() + subject_scoregot.size()
   ...
   // Gets for the different data to be used elsewhere without querying
   // again
