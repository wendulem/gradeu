...
class StudentMainPanel extends JPanel {
	StudentMainPanel(GradeBack gradeback) {
		// JPanel class for GradeBack and for the main student panel and below are the
		// Labels with the supers
		List<ActionListener> actionlisteners = gradeback.getActionListeners();
		...
		// Below, the logout and view (detailed info on subject)buttons get their action
		...
		// View buttons are added next to each super so they need to have their specific
